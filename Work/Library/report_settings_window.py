...
from Work.Scripts.colors import SUCCESS_INFO_COLOR, SEPARATOR_COLOR
from Work.Scripts.styles import SUBTITLE_TEXT_FONT
from Work.Scripts.interactors import ListReportsAdapter
