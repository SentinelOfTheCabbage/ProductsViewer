...
from Work.Scripts.config import WIDTH_FILR_FRAME, COLOR_BG_FRAME_TABLE, COLOR_BG_FRAME_FILTR, FONT_TITLE_FILTR, \
    COLOR_FG_FRAME_FILTR, CURSOR_CHANGE_WIGHT, MIN_WIDTH_TABLE, MIN_WIDTH_FILR_FRAME, COLOR_FG_FRAME_TABLE, \
    COLOR_BG_LAST_CH, HEIGHT_INFO_FRAME, CURSOR_CHANGE_HEIGHT, MIN_SIZE_TABLE, COLOR_BG_TITLE_LAST_CH
