...
from Work.Scripts.src.presentation.reports_settings.settings_bar_chart import \
    SettingsBarChart
from Work.Scripts.src.presentation.reports_settings.settings_box_and_whisker import \
    SettingsBoxAndWhisker
from Work.Scripts.src.presentation.reports_settings.settings_histogram import \
    SettingsHistogram
from Work.Scripts.src.presentation.reports_settings.settings_pivot import SettingsPivot
from Work.Scripts.src.presentation.reports_settings.settings_scatter_chart import \
    SettingsScatterChart
from Work.Scripts.src.presentation.menu_subwindows.db_saver.views import db_saver
