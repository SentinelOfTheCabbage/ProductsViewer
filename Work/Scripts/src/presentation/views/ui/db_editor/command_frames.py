...
from Work.Scripts.src.presentation.presenters.key_words import CompareOp, Expression
from Work.Scripts.src.model.repository.UI_table_constants import ProductColumns
from Work.Scripts.src.presentation.views.ui.custom_widgets import VerticalScrolledFrame, \
