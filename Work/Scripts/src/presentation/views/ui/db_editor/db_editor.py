...
from Work.Scripts.src.presentation.views.ui.custom_widgets import PVStandardButton, PVFrame, \
    PVLabel, PVCombobox
from Work.Scripts.src.presentation.views.ui.db_editor.command_frames import InsertFrame, \
    SelectFrame, UpdateFrame, DeleteFrame
from Work.Scripts.src.presentation.views.ui.main_window.config import MAIN_BACKGROUND
from Work.Scripts.src.presentation.views.ui.main_window.event_listener import IEventListener
