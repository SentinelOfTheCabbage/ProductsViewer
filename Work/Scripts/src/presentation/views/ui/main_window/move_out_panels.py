...
from Work.Scripts.src.presentation.views.ui.main_window.config import COLOR_BG_FRAME_TABLE, \
...
import Work.Scripts.src.presentation.views.ui.main_window.config as conf
