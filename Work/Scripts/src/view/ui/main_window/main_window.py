...
from Work.Scripts.src.view.ui.main_window.config import WIN_W_START, WIN_H_START, \
...
class App:
    ...
    def __init__(self, master, title="Заголовок"):
        self.master = master
        master.title(title)
        master.iconbitmap(r'D:\PycharmProjects\ProductsViewer\Work\Scripts\res\drawable\img.ico')
